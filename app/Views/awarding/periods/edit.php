  ...
  <div class="col-12 col-md-8 offset-md-2">
    <div class="card">
      <div class="card-header">
        <h4>Edit Periode Awarding</h4>
      </div>
      <div class="card-body">
        <form action="<?= base_url('admin/awarding/periods/update/' . $period['id']) ?>" method="post">
          <?= csrf_field() ?>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="description" name="description" rows="3"><?= old('description', $period['description']) ?></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="performance_period_id" name="performance_period_id">
              ...
              <option value="<?= $pp['id'] ?>" <?= old('performance_period_id', $period['performance_period_id']) == $pp['id'] ? 'selected' : '' ?>>
